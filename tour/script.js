            ...
            function loadScene(sceneName) {
                ...
                if (sceneName === 'hallway1') {
                    ...
                    hotspots = [
                        ...
                        {
                            // Hallway 9 hotspot - location pin to go to hallway9
                            pitch: -10,
                            yaw: 206,
                            type: 'custom',
                    ...
                    // Hotspots in hallway9
                    hotspots = [
                        {
                            // Return to hallway8 hotspot
                            pitch: -20,
                            yaw: 393,
                            type: 'custom',
                        ...
                        {
                            // Hallway 10 hotspot - location pin to go to hallway10
                            pitch: -1,
                            yaw: 203,
                            type: 'custom',
